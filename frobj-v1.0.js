...
document.getElementById("gtitle").setAttribute("height", document.getElementById("dgtitle").scrollHeight + 5);
document.getElementById("txaxis").setAttribute("width", document.getElementById("dtxaxis").scrollWidth + 20);
document.getElementById("txaxis").setAttribute("height", document.getElementById("dtxaxis").scrollHeight + 5);
for (var i=1; i <= 50; i++){
document.getElementById("peak"+i).setAttribute("width", document.getElementById("dpeak"+i).scrollWidth + 20);
document.getElementById("peak"+i).setAttribute("height", document.getElementById("dpeak"+i).scrollHeight + 5);
}
})
